            ...
            <Intro />
                <main className="container">
                  <section className="flex justify-center flex-col md:flex-row !items-center md:items-start md:gap-10 gap-5 md:m-20">
                    <Image src="/assets/blog/dynamic-routing/vietnam.jpg" alt="" className="rounded-full " width={250} height={250}></Image>
                      <div className="flex flex-col md:gap-5 justify-center text-center md:text-left">
                        <h1 className="md:text-3xl text-xl font-serif mb-3 ">野に咲く花のブログ</h1>
                        <p className="text-sm md:text-base font-serif">日々のつれづれです</p>
                      </div>
                  </section>

                  <section className="container mx-auto md:w-[700px] md:mt-20 mt-5">
                    <h2 className="font-bold text-gray-600 mb-5 pb-5 uppercase border-b border-gray-300 text-sm tracking-wide">all posts</h2>
                    <ol>
                    {posts.map((post) => {
